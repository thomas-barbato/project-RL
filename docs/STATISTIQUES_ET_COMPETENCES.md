...
Frappe précise (MEL-02) constitue une alternative immédiate à l'attaque ordinaire : A1 applique 75 % des dégâts physiques et ajoute +25 au modificateur de Précision déjà porté par l'arme. Elle ne demande plus une action de préparation, afin que son intérêt soit un choix lisible au moment de frapper plutôt qu'un tour perdu avant une attaque seulement un peu plus fiable. Une cible hors portée, un slot absent ou une arme incompatible refusent toujours la commande sans tour ni tirage. Une arme de mêlée non physique conserve le bonus de touche, mais n'offre aucune composante physique à réduire. Contre une cible facile, la perte de dégâts rend volontairement l'attaque ordinaire préférable.
...
Entrave (MEL-08) constitue le sixième profil offensif de laboratoire. Le corps de la cible déclare explicitement sa compatibilité locomotrice : le moteur ne la déduit ni de son glyphe, ni de sa faction, ni de son IA. Après une touche de mêlée à 50 % des dégâts physiques et un coût de 3 E, une cible compatible effectue un unique test passif de Stabilité contre une intensité 60. Un succès conserve les dégâts déjà résolus mais évite l'état ; un échec applique une Entrave de 2 UT qui porte le coût minimal du déplacement volontaire ordinaire à 2 UT. Plusieurs minima de déplacement retiennent le plus élevé. Le joueur laisse alors réellement deux phases aux acteurs et à l'environnement ; une IA entravée ne reçoit sa prochaine occasion qu'après ces 2 UT. À l'expiration naturelle, l'état applique une protection familiale de 1 UT : une nouvelle application bloquée ne lance aucun jet et ne prolonge pas la protection. Une cible incompatible ou déjà protégée ne consomme elle non plus aucun tirage. La technique engage un cooldown de deux phases environnementales après son exécution, même si la touche est ratée ou la perturbation résistée ; les commandes refusées et une future préparation interrompue avant exécution ne l'engagent pas. Définition des familles, transitions d'expiration, modificateurs de Stabilité, minima de déplacement, résistance, cooldown et événements sont tous déclaratifs. Le client affiche les résultats observables sans révéler la chance cachée.

Écrasement (MEL-09) donne une récompense franche à ce contrôle préalable. La cible doit déjà porter une famille d'Entrave locomotrice ou d'Immobilisation au moment de l'engagement ; la technique n'ajoute aucun état gratuitement et n'exige pas l'apprentissage de MEL-08. La frappe coûte 5 E, applique 220 % aux dégâts physiques, ajoute 2 à la pénétration de Blindage de l'arme pour cet impact puis engage R1, même en cas de raté. Le terrain, un allié ou une autre discipline peuvent donc ouvrir cette fenêtre sans rendre le combo autonome.

Interception (MEL-10) prépare une garde de réaction avant un retrait volontaire depuis le contact. Elle exécute d'abord une frappe de mêlée ordinaire. Si celle-ci touche et que la cible survit, cette cible teste sa Stabilité contre une intensité de 60 ; un échec annule uniquement le déplacement tenté et la laisse sur sa case de départ. Une réussite ou une attaque manquée laisse le retrait se poursuivre. Une poussée, une réaction ou un autre déplacement forcé ne déclenche pas la garde. L'action reste entièrement déclarative : l'ancienne variante sans contrôle demeure lisible pour les sauvegardes et les mods historiques.
...
- Interception : contre un départ volontaire depuis le contact, avant ce départ ; sur une touche, la cible survivante teste sa Stabilité contre l'intensité déclarée. Un échec annule ce retrait sans imposer d'état durable ; une réussite ou une attaque manquée laisse le mouvement se poursuivre. Pas de déclenchement sur poussée ou mouvement de réaction. Pas de riposte à une interception.
...
Lecture locale du 23 septembre : `src/progression/experience.rs` utilise encore la courbe d'amorçage [10, 25, 45, 70, 100, 140, 190], un point par niveau et des règles anti-farming. `src/game/turn.rs`, `src/time.rs` et `src/reaction.rs` portent désormais les durées, préparations, récupérations, cooldowns, droits de réaction et gardes nécessaires. Les dix techniques de Combat rapproché sont chargées dans le contenu standard et exécutées par les primitives communes ; Frappe précise est une attaque immédiate à 75 % et +25 Précision, Écrasement applique ×2,2 et +2 pénétration sous condition, et Interception oppose une touche réussie à la Stabilité avant d'autoriser le retrait. La charge réelle portée intervient dans Repoussement. Blindage, résistances spécialisées, impacts mixtes, pénétrations typées, équipement défensif, Fragilisation, Entrave et interruption de préparation sont raccordés.

La prochaine passe ne consiste donc plus à compléter la liste de mêlée, mais à éprouver son équilibrage en situation : fréquence réelle des cibles difficiles à toucher, occasions d'Entrave provenant de plusieurs sources, valeur de la fenêtre Écrasement et lisibilité des gardes adverses. Chaque évolution doit conserver des tests déterministes hors rendu et éviter qu'une technique apprenable ne devienne un choix mort faute de situation jouable.
