...
- depuis la version 94, une enceinte de surface est éventrée et possède plusieurs approches, tandis que l'autre garde son entrée ordinaire ou verrouillée ; trois comportements d'ennemis (poursuite, escarmouche, sentinelle fixe) sont présents dans chaque région de surface ; au moins un tirage de butin se trouve hors des trois caches, à distance des passages et des caches ;
- depuis la version 95, la cache isolée devient une petite aire de récupération facultative : son accès est occupé par un conteneur instable, destructible à distance ou au contact, dont l'explosion laisse un feu bref ; son tirage de récompense favorise les préparations utiles et cette situation ne dépend d'aucune quête ;
- depuis la version 96, cette aire a deux configurations déterministes selon la région : clôturée, où il faut écarter le conteneur de l'unique accès, ou éventrée, où deux brèches permettent de récupérer le butin en contournant le conteneur, qui reste utilisable comme danger tactique. Les anciennes sauvegardes gardent la configuration clôturée ;
...
Cette organisation est un état de prototype. L'essai de taille et de présence des sites ne représente pas encore les expéditions sauvages, les lieux narratifs garantis et la durée visés par le présent document. Les parties suspendues en version 91 ou antérieure conservent leur taille de 96 × 64 à la surface ; celles de version 92 gardent aussi leurs anciens reliefs, sites et tirages de butin ; celles de version 93 gardent leurs deux profils d'ennemis et leurs anciens tirages ; celles de version 94 ne reçoivent pas la nouvelle aire de récupération. Les villes et les profondeurs ne changent pas. Le conteneur ajoute une décision tactique hors quête, mais ces lieux restent des prototypes compacts. Il faut éprouver la durée des trajets et créer des destinations avec des conséquences et des récompenses plus diverses avant de retenir cette formule.
